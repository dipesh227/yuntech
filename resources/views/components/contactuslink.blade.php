                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-12 col-md-8 text-center mb-5">
                                    ...
                                    <p class="lead">
                                        ...
                                        one? Drop us a line about your project needs, we answer
                                        same day.
                                    </p>
                                </div>
                            </div>
                            <div class="row mb-5">
                                <div class="col-md-4 col-lg-4 text-center">
                                    <div class="icon-box mb-4">
                                        ...
                                        <span>27 Silicon Valley<br />USA, California</span>
                                    </div>
                                </div>
                                <div class="col-md-4 col-lg-4 text-center">
                                    <div class="icon-box mb-4">
                                ...
                                <div class="col-md-4 col-lg-4 text-center">
                                    <div class="icon-box mb-4">
                                        ...
                                        <a href="#"><span class="__cf_email__"
                                                data-cfemail="197c61787469757c597a767469787760377a7674">[email&#160;protected]</span></a><br /><a
                                            href="#"><span class="__cf_email__"
                                                data-cfemail="d3bdb2beb693b0bcbea3b2bdaafdb0bcbe">[email&#160;protected]</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <form class="col-12 col-md-8 mx-auto">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input class="form-control" id="nameInputIcon2" placeholder="e.g. Bonnie Green"
                                        type="text" aria-label="contact name input" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input class="form-control" id="emailInputIcon2" placeholder="example@company.com"
                                        type="email" aria-label="contact email input" />
                                </div>
                            </div>
                            <div class="form-group">
