    ...
    >
      <div class="container position-relative">
        ...
        <div class="navbar-collapse collapse" id="navbar_global">
          ...
          <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a href="../pages/blog.html" class="dropdown-item"
                        >Blog</a
                      >
                      <a href="../pages/blog-post.html" class="dropdown-item"
                        >Blog post</a
                      >
                    </li>
                  </ul>
                ...
                <li class="dropdown-submenu">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a href="../pages/sign-in.html" class="dropdown-item"
                        >Sign in</a
                      >
                      <a href="../pages/sign-up.html" class="dropdown-item"
                        >Sign up</a
                      >
                      <a
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a class="dropdown-item" href="../sections/about.html"
                    >About</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="../sections/blog.html"
                    >Blog</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="../sections/clients.html"
                    >Clients</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="../sections/contact.html"
                    >Contact</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="../sections/features.html"
                    >Features</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="../sections/pricing.html"
                    >Pricing</a
                  >
                </li>
                <li>
                  <a class="dropdown-item" href="../sections/team.html"
                    >Team</a
                  >
                </li>
                <li>
                ...
                <li>
                  <a class="dropdown-item" href="../sections/navbars.html"
                    >Navbars</a
                  >
                </li>
              </ul>
                ...
                <div class="row">
                  ...
                  <div class="col pl-0">
                    <ul class="list-style-none">
                      ...
                      <li>
                        <a class="dropdown-item" href="counters.html"
                          >Counters</a
                        >
                      </li>
                      <li>
                  ...
                  <div class="col pl-0">
                    <ul class="list-style-none">
                      ...
                      <li>
                        <a class="dropdown-item" href="icon-boxes.html"
                          >Icon Boxes</a
                        >
                      </li>
                      <li>
                      ...
                      <li>
                        <a class="dropdown-item" href="owl-carousels.html"
                          >Owl Carousels</a
                        >
                      </li>
                      <li>
                      ...
                      <li>
                        <a class="dropdown-item" href="progress-bars.html"
                          >Progress Bars</a
                        >
                      </li>
                    </ul>
                  ...
                  <div class="col pl-0">
                    <ul class="list-style-none">
                      ...
                      <li>
                        <a class="dropdown-item" href="timelines.html"
                          >Timelines</a
                        >
                      </li>
                      <li>
        ...
        <div class="d-flex align-items-center">
          <a
            href="https://themesberg.com/product/ui-kit/neumorphism-ui-kit-bootstrap-pro"
            target="_blank"
            class="btn btn-primary text-secondary mr-3"
            ><i class="fas fa-shopping-cart mr-2"></i> Buy now</a
          >
          <a
            href="https://themesberg.com/docs/neumorphism-ui/getting-started/quick-start/"
            target="_blank"
            class="btn btn-primary d-none d-md-inline-block"
            ><i class="fas fa-book mr-2"></i> Docs v1.0</a
          >
          <button
